...
describe "discourses/new.html.haml" do
  before(:each) do
    assign(:discourse, stub_model(Discourse,
      :subject => "MyString",
      :text => "MyText",
      :author_id => 1,
      :assigner_id => 1
  ...
  it "renders new discourse form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => discourses_path, :method => "post" do
